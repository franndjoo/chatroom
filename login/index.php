...
<body style="margin:0;padding:0;">
    ...
    <header style="display:flex; justify-content: space-between; align-items: center;">
        <h1 id="header-h1">🐦 ChatRoom - Login</h1>
    </header>
    <main>
        ...
        <div id="login-box">
            ...
            <div style="display: flex; flex-direction: column; width: 70%;">
                ...
                <input type="text" placeholder="password" id="pwd" type="password" />
            </div>
            <div style="display: flex; justify-content: space-between; align-items: center; width: 90%;">
                <a href="/chat-room/signup">Sign up instead.</a>
                <input id="login-invoker" type="submit" value="Login" />
            </div></div>
        </div>
    </main>
